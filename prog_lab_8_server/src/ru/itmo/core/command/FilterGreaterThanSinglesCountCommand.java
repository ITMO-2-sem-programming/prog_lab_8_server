...
public class FilterGreaterThanSinglesCountCommand extends Command {
     ...
     * @return
     */
    public static String execute(ConcurrentSkipListMap<Integer, MusicBand> collection, int singlesCount) {
    ...
    public static String execute(ConcurrentSkipListMap<Integer, MusicBand> collection, String singlesCount) {

...
//        String getMusicBandByIdQuery = ; // Any useful thing after doing this way ?
    ...
    public static Connection connectDataBase(String dataBaseUrl, String user, String password) throws SQLException {
    ...
    public static Connection connectDataBase(String user, String password) throws SQLException {
        ...
        connection = DriverManager.getConnection(PortForwarder.forwardAnyPort(), user, password);
    ...
    public static void updateMusicBandByID(Connection connection, MusicBand mb, int musicBandID) {
        ...
        try {
            ...
            try {
                ...
                ps.setTimestamp(++i, new Timestamp(mb.getCreationDate().getTime()));
    ...
    private static MusicBand getMusicBandFromResultSet(ResultSet resultSet) {
        ...
        try {
            ...
            musicBand.setCreationDate(new java.util.Date(resultSet.getTimestamp("mb_creation_date").getTime()));
